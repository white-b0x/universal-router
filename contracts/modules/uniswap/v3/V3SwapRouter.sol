...
abstract contract V3SwapRouter is UniswapImmutables, Permit2Payments, IETCswapV3SwapCallback {
    ...
    function etcswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata data) external {
    ...
    /// @notice Performs an ETCswap V3 exact input swap
    ...
    /// @notice Performs an ETCswap V3 exact output swap
    /// @param recipient The recipient of the output tokens
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IETCswapV3Pool(computePoolAddress(tokenIn, tokenOut, fee))
            .swap(
                recipient,
                zeroForOne,
                amount,
